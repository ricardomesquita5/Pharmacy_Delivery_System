...
class VertexTest {
    ...
    /**
     * Instantiates a new Vertex test.
     */
    public VertexTest() {
    }
    ...
    public void testEquals() {
        ...
        assertNotEquals(other, instance, "instance should not be equal to other");
        Vertex<String,Integer> otherTest = null;
        assertNotEquals(otherTest, instance);
        User u = new User("Nelson","Nelson@gmail.com","Jordao");
        assertNotEquals(u, instance);
    }
    ...
    void testhashCode(){
        ...
        Vertex<String, Integer> instance1 = new Vertex<>() ;
